...
def declare_flags(distributed = False):
    ...
    tf.app.flags.DEFINE_boolean("unk_replace", False, "Whether do the unk replacement.")

    tf.app.flags.DEFINE_string("unk_replace_file", "lex.e2f", "The lexical translation table file generated by moses.")
...
def parsing_flags(_FLAGS):
    ...
    if _FLAGS.mode in ["BEAM_DECODE",'FORCE_DECODE','DUMP_LSTM']:
        ...
        if _FLAGS.mode == "BEAM_DECODE" and (_FLAGS.coverage_beta > 0.0 or _FLAGS.unk_replace):
