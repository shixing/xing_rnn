...
class SampleCellWrapper(tf.nn.rnn_cell.RNNCell):
    ...
    def __init__(self, cell, input_embedding, output_embedding, output_bias, tf_dtype = tf.float32):
        self._cell = cell
    ...
    def default_init_state(self, batch_size, state):
        ...
        _go_state = array_ops.ones([batch_size,1], dtype=self.tf_dtype)
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        outputs = tf.cast(tf.multinomial(logits,1),self.tf_dtype)
