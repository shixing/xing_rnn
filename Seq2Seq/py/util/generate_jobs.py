...
ROOT_DIR=/home/nlg-05/xingshi/workspace/misc/lstm/tensorflow/xing_rnn/Seq2Seq/
...
def main(acct=0):
    ...
    _learning_rates = [0.1,0.05,0.01,0.005]

    gen = ((s,n,d,l) for s in _sizes for n in _num_layers for d in _dropouts for l in _learning_rates)
