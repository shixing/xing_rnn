...
python $PY --mode TRAIN --model_dir $MODEL_DIR --train_path_from $TRAIN_PATH_FROM --dev_path_from $DEV_PATH_FROM --train_path_to $TRAIN_PATH_TO --dev_path_to $DEV_PATH_TO --saveCheckpoint True --allow_growth True  --batch_size 4 --size 100 --keep_prob 0.7 --learning_rate 0.001 --n_epoch 100 --num_layers 2 --from_vocab_size 100 --to_vocab_size 100 --min_source_length 0 --max_source_length 22 --min_target_length 0 --max_target_length 22 --n_bucket 2 --optimizer adam  --N 00000 --fromScratch True --variational_dropout True --layer_normalization True 2>smallm4h100d07l01n2adagradAddNS.err.txt 
